# Swiggy MCP Replication Blueprint for Zomato + Blinkit

## CONFIRMED vs INFERRED
- **CONFIRMED (Swiggy docs):** 3 MCP servers (Food, Instamart, Dineout), streamable HTTP MCP, OAuth 2.1 + PKCE, server endpoints pattern (`/food`, `/im`, `/dineout`), tool-driven agent loop.
